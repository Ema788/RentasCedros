...
<html lang="en">
    <head>
        ...
        <title>CINE 2.0 | Conócenos</title>
        <!-- Favicon-->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="<?php echo base_url(RECURSOS_USER_IMG_TEAM.'Jess.jpeg')?>" alt="..." />
                    ...
                    <div class="col-lg-6">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="<?php echo base_url(RECURSOS_USER_IMG_TEAM.'Ema.jpeg')?>" alt="..." />
                    ...
                    <div class="col-lg-6">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="<?php echo base_url(RECURSOS_USER_IMG_TEAM.'Fanni.jpeg')?>"  alt="..." />
                            <h4>Fanni Leilani Gutierrez Pacheco</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="<?php echo base_url(RECURSOS_USER_IMG_TEAM.'Ami.jpeg')?>"  alt="..." />
                            <h4>Amairani Cuaquetzi Tlecuitl</h4>
                ...
                <div class="row no-gutters my-5">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="px-5 py-5 py-lg-0 my-5 my-lg-0 sc-bxivhb hgSmeg">
                            ...
                            <li class="nav-item">
                            <a class="nav-link py-1 text-white" href="/Portal/about">Sobre CineJED</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link py-1 text-white" href="/Portal/about">Bolsa de trabajo cines</a></li></ul>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">

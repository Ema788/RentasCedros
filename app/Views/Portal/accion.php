...
<head>
    ...
    <title>CINE 2.0 | Películas de acción</title>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'adam.png') ?>" alt="..." />
                            </a>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'batman.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'bullet.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'ciudad.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'doctor.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'Gun.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal7">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'hombre.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal8">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'proyecto.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal9">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'sonic.webp') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal10">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'thor.webp') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal11">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'toronto.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal12">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_ACCION . 'unc.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>

...
<head>
    ...
    <title>CINE 2.0 | Películas familiares</title>
    <!-- Favicon-->
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'angry2.jpg') ?>" alt="..." />
                            </a>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'baby.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'brujas.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'buz.png') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'dc.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'era.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal7">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'red.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal8">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'pinocho.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal9">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'hotel.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal10">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'minions.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal11">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_FAMILIARES . 'peter.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>

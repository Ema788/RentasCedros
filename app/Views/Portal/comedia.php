...
<head>
    ...
    <title>CINE 2.0 | Películas de comedia</title>
    <!-- Favicon-->
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'adios.jpg') ?>" alt="..." />
                            </a>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'chav.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'cover.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'donde.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'efecto.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'historia.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-bs-dismiss="modal"><img src="<?php echo base_url(RECURSOS_PORTAL_IMG . 'close.png') ?>" alt="Close modal" style="width: 100%;"></div>
                    <div class="container">
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal7">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'mama.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal8">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'palm.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal9">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'patron.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal10">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'perfecta.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal11">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'poli.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal12">
                                ...
                                <img class="img-fluid" src="<?php echo base_url(RECURSOS_USER_IMG_COMEDIA . 'round.jpg') ?>" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <br>
